...
public enum Commands {
    ...
    INGREDIENTS("Введите ингредиенты, которые у вас имеются\nВведите ингредиенты, которые у вас имеются через запятую без пробела"),

    INGREDIENTS_TO_ADD("Введите ингредиенты, из которых будет приготовлено блюдо"),
